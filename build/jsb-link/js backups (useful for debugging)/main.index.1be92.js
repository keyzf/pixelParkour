...
InfiniteScrollScenesCamera: [ function(t, e, n) {
"use strict";
...
StartGameController: [ function(t, e, n) {
"use strict";
...
return "Map" === n || "Set" === n ? Array.from(t) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? s(t, e) : void 0;
}
}
function s(t, e) {
...
for (var t, e = o(this._randomMonsterList); !(t = e()).done; ) {
var n = t.value;
cc.isValid(n.monsterItem) && n.monsterItem.destroy();
}
...
TouchEventControl: [ function(t, e, n) {
"use strict";
